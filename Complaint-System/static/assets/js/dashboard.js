(function ($) {
  ...
  $(function () {
    ...
    var doughnutChartCanvas = $("#sessionsDoughnutChart").get(0).getContext("2d");
        ...
        if ($("#complaintStatusChart").length) {
            var complaintStatusChartCanvas = $("#complaintStatusChart").get(0).getContext("2d");
            var complaintStatusChart = new Chart(complaintStatusChartCanvas, {
                type: 'doughnut', // or 'pie' if you want a pie chart
                data: doughnutPieData,
                options: doughnutPieOptions // Ensure you are using the updated options
            });
        }
  });
})(jQuery);